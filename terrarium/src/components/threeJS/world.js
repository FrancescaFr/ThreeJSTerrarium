...
import { useFrame, useThree, extend } from "@react-three/fiber"; //useThree, 
// import { WebGLRenderer } from "@react-three/fiber"
import { OrbitControls, PerspectiveCamera, Stars, Sky, Cloud, Environment } from "@react-three/drei";
...
const World = ({ xyCoord, defaultEyeFeatures, eyeFeatures, userPositionData }) => {
  ...
  return <>
    ...
    <PerspectiveCamera makeDefault fov={45} zoom={1} near={0.1} far={200} position={[1, 1, 5]} />
    <OrbitControls />
